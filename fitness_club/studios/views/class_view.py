...
class DeleteClassView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        return Response("Send post request to delete all future sessions for this class from your schedule!")
...
class EnrollEventView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if event.start_time < timezone.now():
            return Response("Error! Can not enroll in this session because it has already happened!")
...
class DeleteEventView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if event.start_time < timezone.now():
            return Response("Error! Can not unenroll in this session because it has already happened!")
